...
class Test4Page extends StatefulWidget {
  ...
  final String userId;
  const Test4Page({super.key, required this.userId, this.onNextStepUnlocked});

  @override
  _Test3PageState createState() => _Test3PageState();
}

class _Test3PageState extends State<Test4Page> {
...
/*  FlutterSoundRecorder? _audioRecorder;
  ...
  Future<void> fetchInterviewQuestion() async {
    ...
    try {
      final question = await openAIService.generateInterviewQuestion4();
      if (mounted) {
        setState(() {
